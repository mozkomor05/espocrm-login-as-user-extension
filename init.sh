...
find ./ -type f -exec sed -i "s/8.1/$PHPVER/g" {} \;
find ./ -type f -exec sed -i "s/LoginAsUser/$REPCAMEL/g" {} \;
find ./ -type f -exec sed -i "s/login-as-user/$REPDASH/g" {} \;
find ./ -type f -exec sed -i "s/Adds "Login as User" feature for administrators, making it, for example, easier to debug ACL./$DESC/g" {} \;
